...
public class FolderItem extends AbstractStreamItem {
	...
	public FolderItem(String folderName, StreamItem parent, StreamItem[] children) {
		...
		super(IconHelper.getImage("temp://FOLDER"), null, folderName);
		this.folderName = folderName;
		this.parent = parent;
		this.children = children;
		this.rawImg = IconHelper.getImage("temp://FOLDER");
		this.img = this.folderName != null ? IconHelper.addText(this.rawImg, this.folderName, IconHelper.TEXT_BOTTOM) : this.rawImg;
